public class StringDNA {
    ...
    public int quantosA() { return contar('A'); }
    public int quantosC() { return contar('C'); }
    public int quantosG() { return contar('G'); }
    public int quantosT() { return contar('T'); }
    ...
    public StringDNA reversoComplementar() {
        ...
        complementar.reverse();
        
        return new StringDNA(complementar.toString());
    }
}
